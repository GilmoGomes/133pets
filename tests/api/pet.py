...
# Configura
  ...
  # Resultado Esperado
    ...
    nome_pet_esperado = 'Saymon'
    tag_esperada = 'Vacinado'

# Executa
    resultado_obtido = requests.post(url=base_url + '/pet',
      data=open('C:\\Users\\gilmo.gomes\\PycharmProjects\\133pets\\vendors\\json\\pet1.json',
                'rb'),
      headers=headers
    )
# Valida
...
def testar_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=f'{base_url}/pet',
        data=open('C:\\Users\\gilmo.gomes\\PycharmProjects\\133pets\\vendors\\json\\pet2.json',
                  'rb'),
        headers=headers
    )
